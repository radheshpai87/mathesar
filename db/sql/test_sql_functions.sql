...
CREATE TABLE "Counselors" (
  /* attnum: 1 */ coid numeric UNIQUE,
  /* attnum: 2 */ "Name" text,
  /* attnum: 3 */ "Email" text
);
CREATE TABLE "Teachers" (
  /* attnum: 1 */ id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  /* attnum: 2 */ "Counselor" numeric REFERENCES "Counselors" (coid),
  /* attnum: 3 */ "Name" text,
  /* attnum: 4 */ "Email" text
);
CREATE TABLE "Students" (
  /* attnum: 1 */ id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  /* attnum: 2 */ "Counselor" numeric REFERENCES "Counselors" (coid),
  /* attnum: 3 */ "Teacher" integer REFERENCES "Teachers" (id),
  /* attnum: 4 */ "Name" text,
  /* attnum: 5 */ "Grade" integer,
  /* attnum: 6 */ "Email" text
);
...
( /* id */  "Counselor", "Teacher", "Name"            , "Grade", "Email"                   ) VALUES
  /* 1  */ ( 2.345     , 3        , 'Fred Fredrickson', 95     , 'ffredrickson@example.edu'),
  /* 2  */ ( 1.234     , 1        , 'Gabby Gabberson' , 100    , 'ggabberson@example.edu'  ),
...
CREATE OR REPLACE FUNCTION test_custom_record_summary_template() RETURNS SETOF TEXT AS $$
BEGIN
  PERFORM __setup_preview_fkey_cols();
...
BEGIN
  ...
  -- Show that record summaries cannot be generated for counselors because the table doesn't have
